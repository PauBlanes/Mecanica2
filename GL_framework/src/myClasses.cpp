...
void particleManager::CalculateForces() {
	...
	for (int i = 0;i < 18 * 14;i++) {
		...
		if (i % 14 != 13) { //si no es de la columna de la dreta
			particles[i].fElasticFromRight = -(keStruct*(length(particles[i].position - particles[i + 1].position) - lHorizontal) /* - (ke (||P1-P2|| - L12)) + */
				+ kdStruct*(particles[i].velocity - particles[i + 1].velocity) * ((particles[i].position - particles[i + 1].position) / (length(particles[i].position - particles[i + 1].position)))); //+ kd(v1-v2)*P1-P2/||P1-P2||)
		...
		if (i < 17 * 14) { //si no es de la ultima fila
			particles[i].fElasticFromDown = -(keStruct*(length(particles[i].position - particles[i + 14].position) - lVertical) /* - (ke (||P1-P2|| - L12)) + */
				+ kdStruct*(particles[i].velocity - particles[i + 14].velocity) * ((particles[i].position - particles[i + 14].position) / (length(particles[i].position - particles[i + 14].position)))); //+ kd(v1-v2)*P1-P2/||P1-P2||)
		...
		if (i % 14 != 13 && i < (17 * 14)) { //si no es de la columna de la dreta i si no es de la ultima fila
			...
			particles[i].fShearDownR = -(keShear*(length(particles[i].position - particles[i + 15].position) - lHorizontal*(float)sqrt(2))
				+ kdShear*(particles[i].velocity - particles[i + 15].velocity) * ((particles[i].position - particles[i + 15].position) / (length(particles[i].position - particles[i + 15].position))));
		...
		if (i < (17 * 14) && i % 14 != 0) { //si no es de la ultima fila i si no es de la columna de la esquerra
			particles[i].fShearDownL = -(keShear*(length(particles[i].position - particles[i + 13].position) - lVertical*(float)sqrt(2))
				+ kdShear*(particles[i].velocity - particles[i + 13].velocity) * ((particles[i].position - particles[i + 13].position) / (length(particles[i].position - particles[i + 13].position))));
		...
		if (i % 14 < 12) { //si no es de la columna de la dreta
			particles[i].fBendingR = -(keBend*(length(particles[i].position - particles[i + 2].position) - lHorizontal*2) /* - (ke (||P1-P2|| - L12)) + */
				+ kdBend*(particles[i].velocity - particles[i + 2].velocity) * ((particles[i].position - particles[i + 2].position) / (length(particles[i].position - particles[i + 2].position)))); //+ kd(v1-v2)*P1-P2/||P1-P2||)
		...
		if (i < 16 * 14) { //si no es de la 2 ultima fila
			particles[i].fBendingD = -(keBend*(length(particles[i].position - particles[i + 28].position) - lVertical*2) /* - (ke (||P1-P2|| - L12)) + */
				+ kdBend*(particles[i].velocity - particles[i + 28].velocity) * ((particles[i].position - particles[i + 28].position) / (length(particles[i].position - particles[i + 28].position)))); //+ kd(v1-v2)*P1-P2/||P1-P2||)
